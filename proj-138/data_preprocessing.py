...
#Algo
#take a word from stem_words_list
#create an empty array of bag_of_words
#Stem pattern words before creating BOW
#check if that word is in stemmed_pattern_word
#append 1 in BOW,otherwise append 0
